                    ...
                    <div class="card-body">
                            <form action="{{route('contact.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="floatingName" placeholder="John Doe" value="{{old('name')}}">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="number" name="phone" class="form-control @error('phone') is-invalid @enderror" id="floatingPhone" placeholder="0987654321" value="{{old('phone')}}">
